...
<div id="getting_started" class="spicepress-dark-tab-pane active">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="spicepress-dark-info-title text-center"><?php echo esc_html__('About the SpicePress Dark theme','spicepress-dark'); ?>
				</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				...
				<h1 style="margin-top: 73px !important; font-size:2em !important; background: #0085ba;border-color: #0073aa #006799 #006799; color: #fff; padding: 5px 10px; line-height: 40px;"><?php esc_html_e( "Getting Started", 'spicepress-dark' ); ?></h1>
				<div>
